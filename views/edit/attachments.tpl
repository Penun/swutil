<div ng-show="mCont.ShowTab(7)" class="sixty_he editGrid">
    ...
    <div class="right_page right_page_form">
        <form id="attaAddForm" name="attaAddForm" novalidate>
            ...
            <p><label><b>Price:</b></label><input type="number" name="attaPrice" ng-model="moldAtta.price" min="0" step="5" required/></p>
            ...
            <div class="abilities"><label><b>Base Modifiers:</b></label><textarea name="attaBase" ng-model="moldAtta.base_mod" rows="5"></textarea></div>
