		...
		<div class="page sw_back">
            <div ng-show="mCont.ShowStep(1)" class="sixty_he">
                <form id="charAddForm" name="charAddForm" novalidate>
                    <p><label><b>Name:</b></label><input type="text" name="charName" id="charName" ng-model="mCont.char.name" tabindex="1" autofocus required/></p>
                    <p><label><b>Wound Threshold:</b></label><input type="number" name="cahrWound" id="charWound" ng-model="mCont.char.wound" min="0" tabindex="2" required/></p>
                    <p><label><b>Strain Threshold:</b></label><input type="number" name="charStrain" id="charStrain" ng-model="mCont.char.strain" min="0" tabindex="3" required/></p>
